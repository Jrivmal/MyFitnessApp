...
@Endpoint
@AnonymousAllowed
public class FitnessAppEndpoint {

    private final FitnessAppService service;

    public FitnessAppEndpoint(FitnessAppService service) {
        this.service = service;
    }

    public Page<FitnessApp> list(Pageable page) {
